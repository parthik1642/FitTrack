...
type EditNavigationProp = NativeStackNavigationProp<HomeStackParamList, "EditWorkout">;
...
export default function EditWorkoutScreen() {
  ...
  const handleUpdate = () => {
    ...
    try {
      updateWorkout(id, { title: newTitle, category: newCategory, duration: Number(newDuration), calories: Number(newCalories), date: newDate });
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
            ...
            <Reanimated.View entering={FadeInDown.delay(100).duration(500).springify().damping(16)} style={styles.cardOuter}>
              <BlurView intensity={35} tint="dark" style={styles.card}>
                ...
                <Reanimated.View entering={FadeInUp.delay(380).duration(400)} style={[styles.btnWrap, btnStyle]}>
                  <TouchableOpacity
                    activeOpacity={1}
...
const styles = StyleSheet.create({
  ...
  btn: {
    ...
    shadowColor: "#7C3AED", shadowOpacity: 0.5, shadowRadius: 14, shadowOffset: { width: 0, height: 5 },
  },
