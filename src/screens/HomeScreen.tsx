...
function FloatingBackground({ scrollY }: { scrollY: SharedValue<number> }) {
  ...
  useEffect(() => {
    ...
    rot1.value = withRepeat(
      withSequence(withTiming(8, { duration: 4000 }), withTiming(-6, { duration: 3500 })),
      -1,
      true
    );
    ...
    rot2.value = withDelay(
      400,
      withRepeat(
        withSequence(withTiming(-12, { duration: 3800 }), withTiming(8, { duration: 3200 })),
        -1,
        true
      )
    );
...
function HeroGlow() {
  ...
  useEffect(() => {
    ...
    opacity.value = withRepeat(
      withSequence(withTiming(0.7, { duration: 2000 }), withTiming(0.3, { duration: 1800 })),
      -1,
      true
    );
  }, []);
    ...
    3D Mode
                  ...
                  <View style={styles.progressBarWrap}>
                    ...
                    <Text style={styles.progressLabel}>
                      Level {level} · {totalWorkouts % 5}/5 to next
                    </Text>
                  </View>
                </BlurView>
              </Reanimated.View>
